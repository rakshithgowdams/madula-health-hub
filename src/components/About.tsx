      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <img
            ...
            className="absolute -bottom-8 right-0 w-48 md:w-56 rounded-2xl shadow-xl border-4 border-card object-cover"
            loading="lazy"
          />
          {/* Rotating badge */}
          <div className="absolute -bottom-4 left-4 w-20 h-20">
            <svg viewBox="0 0 100 100" className="animate-spin-slow w-full h-full">
              ...
              <text fontSize="9" fontWeight="600" fill="hsl(var(--primary))">
                <textPath href="#circlePath">MADULA MEDICAL • DOCTORS SEARCH •</textPath>
              </text>
            </svg>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            We are dedicated to delivering compassionate and innovative medical services. Our team of experienced professionals strives for excellence in every aspect of patient care.
          </p>
          ...
          <div className="flex items-center gap-6 mb-8">
            <motion.a
              ...
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-full text-sm font-medium"
            >
